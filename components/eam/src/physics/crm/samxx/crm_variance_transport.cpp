...
void VT_filter(int filter_wn_max, real4d &f_in, real4d &f_out) {
  ...
  fftx.forward_real( fft_out );  // Batched over y and z dimensions
  ...
  if (RUN3D) {
    ...
    ffty.forward_real( fft_out );  // Batched over x and z dimensions
  }
  ...
  if (RUN3D) {
    ...
    //});
    ffty.inverse_real( fft_out );  // Batched over x and z dimensions  
  }
  ...
  //});
  fftx.inverse_real( fft_out );  // Batched over x and z dimensions
