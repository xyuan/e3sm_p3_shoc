...
DEFS2D=" -DNCRMS=$NCRMS2D -DCRM -DCRM_NX=$NX -DCRM_NY=$NY -DCRM_NZ=$NZ -DCRM_NX_RAD=$NX_RAD -DCRM_NY_RAD=$NY_RAD -DCRM_DT=$DT -DCRM_DX=$DX -DYES3DVAL=$YES3D -DPLEV=$PLEV -DMicro_p3 -DShoc -DMMF_STANDALONE"
...
DEFS3D=" -DNCRMS=$NCRMS3D -DCRM -DCRM_NX=$NX -DCRM_NY=$NY -DCRM_NZ=$NZ -DCRM_NX_RAD=$NX_RAD -DCRM_NY_RAD=$NY_RAD -DCRM_DT=$DT -DCRM_DX=$DX -DYES3DVAL=$YES3D -DPLEV=$PLEV -DMicro_p3 -DShoc -DMMF_STANDALONE"
...
## RUN THE CONFIGURE
############################################################################
FFLAGS="$FFLAGS -I$NCHOME/include -I$NFHOME/include -I$MPIHOME/include "
CXXFLAGS="$CXXFLAGS -I$NCHOME/include -I$NFHOME/include -I$MPIHOME/include "
